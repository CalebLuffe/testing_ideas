...
script creates a stored procedure in the database that you want to maintain. 
The logic of this script is to check index fragmentation and the number of pages.
 
For example, if an index has fragmentation more than 30% and the number of pages 
is less than 10 then the index is reorganized. 

Instructions on how to use this Stored Procedure

1:  Create the stored procedure in your database.

2: On Object Explorer - Management - Maintenance Plans, create a new maintenance plan.

3: From the left pane Toolbox, drag and drop [Execute T-SQL Statement Task] element to the plan.

	3.1: Open [Execute T-SQL Statement Task] element by double clicking or right click and select Edit...

	3.2: Type the following T-SQL Statement and click OK.

Then anytime you want to run this, all you have to do is just open the window and type this:
